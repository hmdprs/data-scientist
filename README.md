...
- [Hello, Python](#hello-python)
    ...
    - [Numbers and Arithmetic in Python](#numbers-and-arithmetic-in-python)
    - [Built-in Functions for Working with Numbers](#built-in-functions-for-working-with-numbers)
- [Functions and Getting Help](#functions-and-getting-help)
    - [Getting Help](#getting-help)
    - [Functions](#functions)
        - [Docstrings](#docstrings)
        - [Functions w/o Return](#functions-wo-return)
...
- [Booleans and Conditionals](#booleans-and-conditionals)
    ...
    - [Conditionals](#conditionals)
        - [Trues and Falses](#trues-and-falses)
...
- [Lists](#lists)
    - [Lists](#lists-1)
        ...
        - [Python Attributes & Methods](#python-attributes--methods)
...
- [Loops and List Comprehensions](#loops-and-list-comprehensions)
    ...
    - [Enumerate](#enumerate)
- [String and Directories](#string-and-directories)
    - [Strings](#strings)
        - [String Methods](#string-methods)
        - [String and List, Back and Forward](#string-and-list-back-and-forward)
        - [String Formatting](#string-formatting)
    - [Dictionaries](#dictionaries)
        - [Dictionary Comprehensions](#dictionary-comprehensions)
        - [Access to all Keys or all Values](#access-to-all-keys-or-all-values)
        - [Get key by value](#get-key-by-value)
        - [`in`](#in)
        - [Loops in Dictionaries](#loops-in-dictionaries)
...
<details><summary><a href="#numpy">NumPy</a></summary>

- [The Basics](#the-basics)
- [Functions and Methods](#functions-and-methods)
- [Indexing and Slicing](#indexing-and-slicing)
    - [Indexing with Numerical Arrays](#indexing-with-numerical-arrays)
    - [Indexing with Boolean Arrays](#indexing-with-boolean-arrays)
    - [The ix_() function](#the-ix_-function)
...
<details><summary><a href="#pandas">Pandas</a></summary>
...
- [Indexing, Selecting & Assigning](#indexing-selecting--assigning)
    - [Naive Accessors](#naive-accessors)
    - [Indexing in Pandas](#indexing-in-pandas)
        ...
        - [Inclusive Range, `iloc` vs. `loc`](#inclusive-range-iloc-vs-loc)
        - [Manipulating the Index](#manipulating-the-index)
    - [Conditional Selection](#conditional-selection)
        - [Built-in Conditional Selectors](#built-in-conditional-selectors)
...
- [Summary Functions and Maps](#summary-functions-and-maps)
    ...
    - [Maps](#maps)
        - [`map()`](#map)
        - [`apply()`](#apply)
        - [Pandas built-ins Common Mapping Operators](#pandas-built-ins-common-mapping-operators)
- [Grouping and Sorting](#grouping-and-sorting)
    - [Groupwise Analysis](#groupwise-analysis)
        - [`groupby()`](#groupby)
        - [Aggregate Different Functions Simultaneously](#aggregate-different-functions-simultaneously)
        - [Multi-indexes, Group by More than One Column](#multi-indexes-group-by-more-than-one-column)
    - [Sorting](#sorting)
        - [`sort_values()`](#sort_values)
        - [Sort by More than One Column](#sort-by-more-than-one-column)
        - [`sort_index()`](#sort_index)
- [Data Types and Missing Values](#data-types-and-missing-values)
    - [Dtypes](#dtypes)
    - [Missing Values (NaNs)](#missing-values-nans)
        - [`isna()`, `notna()`](#isna-notna)
        - [`fillna()`](#fillna)
        - [`replace()`](#replace)
        - [`dropna()`](#dropna)
...
<details><summary><a href="#data-visualization">Data Visualization</a></summary>

- [Line Charts](#line-charts)
    - [Set up the notebook](#set-up-the-notebook)
    - [Line Chart](#line-chart)
- [Bar Charts and Heatmaps](#bar-charts-and-heatmaps)
    - [Bar Chart](#bar-chart)
    - [Heatmap](#heatmap)
...
- [Distributions](#distributions)
    - [Histogram](#histogram)
    - [Color-coded Plots](#color-coded-plots)
- [Choosing Plot Types](#choosing-plot-types)
    - [Trends](#trends)
    - [Relationship](#relationship)
    - [Distribution](#distribution)
- [Final Project](#final-project)
    - [Use your own dataset](#use-your-own-dataset)
- [Creating Your Own Notebooks](#creating-your-own-notebooks)

</details>

<details><summary><a href="#geospatial-analysis">Geospatial Analysis</a></summary>
...
- [Coordinate Reference Systems](#coordinate-reference-systems)
    ...
    - [Techniques from the Exercise](#techniques-from-the-exercise)
...
- [Proximity Analysis](#proximity-analysis)
    ...
    - [Make a Recommender](#make-a-recommender)

</details>

<details><summary><a href="#intro-to-machine-learning">Intro to Machine Learning</a></summary>
...
- [Model Validation](#model-validation)
    - [Summarizing the Model Quality into Metrics](#summarizing-the-model-quality-into-metrics)
    - [Validation Data](#validation-data)
- [Underfitting and Overfitting](#underfitting-and-overfitting)
- [Random Forests](#random-forests)
    - [Introduction](#introduction-3)
    - [Random Forest](#random-forest)
- [Exercise: Machine Learning Competitions](#exercise-machine-learning-competitions)
    - [Setup](#setup)
    - [Evaluate Several Models](#evaluate-several-models)
    - [Generate Test Predictions](#generate-test-predictions)

</details>

<details><summary><a href="#intermediate-machine-learning">Intermediate Machine Learning</a></summary>
...
- [Cross-Validation](#cross-validation)
    ...
    - [Obtain the Cross-validation Scores](#obtain-the-cross-validation-scores)
        - [Combine them as a Function](#combine-them-as-a-function)
        - [Evalute the Model Performance](#evalute-the-model-performance)
        - [Find the best Parameter Value](#find-the-best-parameter-value)
- [XGBoost](#xgboost)
...
- [Data Leakage](#data-leakage)
    ...
    - [Examples](#examples)
        - [The Data Science of Shoelaces](#the-data-science-of-shoelaces)
        - [Getting Rich with Cryptocurrencies](#getting-rich-with-cryptocurrencies)
        - [Housing Prices](#housing-prices)
        - [Credit Card Applications](#credit-card-applications)

</details>

<details><summary><a href="#feature-engineering">Feature Engineering</a></summary>

- [Baseline Model](#baseline-model)
    - [Introduction](#introduction-11)
    - [Preparing Target Column](#preparing-target-column)
    - [Converting Timestamps](#converting-timestamps)
    - [Preparing Categorical Variables](#preparing-categorical-variables)
    - [Creating Training, Validation, and Test Splits](#creating-training-validation-and-test-splits)
    - [Training a LightGBM Model](#training-a-lightgbm-model)
    - [Making Predictions](#making-predictions)
- [Categorical Encodings](#categorical-encodings)
    - [Introduction](#introduction-12)
    - [Count Encoding, Target Encoding & CatBoost Encoding](#count-encoding-target-encoding--catboost-encoding)
  - [Feature Generation](#feature-generation)
    - [Introduction](#introduction-13)
    - [Interactions](#interactions)
    - [Number of Projects in the Last Week](#number-of-projects-in-the-last-week)
    - [Time since the Last Project in the Same Category](#time-since-the-last-project-in-the-same-category)
    - [Transforming Numerical Features: Tree-based vs Neural Network Models](#transforming-numerical-features-tree-based-vs-neural-network-models)
- [Feature Selection](#feature-selection)
    - [Introduction](#introduction-14)
    - [Univariate Feature Selection](#univariate-feature-selection)
    - [L1 Regularization](#l1-regularization)
    - [Feature Selection with Trees](#feature-selection-with-trees)

</details>

<details><summary><a href="#deep-learning">Deep Learning</a></summary>

- [Intro to DL for Computer Vision](#intro-to-dl-for-computer-vision)
    - [Intro](#intro)
- [Building Models from Convolutions](#building-models-from-convolutions)
    - [Intro](#intro-1)
    - [Convolutions](#convolutions)
    - [Object Detection](#object-detection)
- [TensorFlow Programming](#tensorflow-programming)
    - [Intro](#intro-2)
    - [Pre-processing](#pre-processing)
    - [Using pre-trained Models](#using-pre-trained-models)
    - [Decode Predictions](#decode-predictions)
...
- [Data Augmentation](#data-augmentation)
    - [Intro](#intro-4)
- [A Deeper Understanding of Deep Learning](#a-deeper-understanding-of-deep-learning)
    - [Intro](#intro-5)
    - [Forward Propagation, Softmax, ReLU](#forward-propagation-softmax-relu)
    - [Loss Functions, (Stochastic) Gradient Descent](#loss-functions-stochastic-gradient-descent)
    - [Back Propagation, Learning Rate](#back-propagation-learning-rate)
- [Deep Learning from Scratch](#deep-learning-from-scratch)
    - [Intro](#intro-6)
    - [Data Preparation](#data-preparation)
    - [Specify Model](#specify-model-1)
    - [Compile Model](#compile-model-1)
    - [Fit Model](#fit-model-1)
- [Dropout and Strides for Larger Models](#dropout-and-strides-for-larger-models)
    - [Stride Lengths](#stride-lengths)
    - [Dropout](#dropout)
    - [Have Fun with some COOL Datasets](#have-fun-with-some-cool-datasets)

</details>

<details><summary><a href="#intro-to-sql">Intro to SQL</a></summary>

- [Getting Started with SQL and BigQuery](#getting-started-with-sql-and-bigquery)
    - [Intro](#intro-7)
    - [Table Schema](#table-schema)
- [Select, From & Where](#select-from--where)
    - [Setup](#setup-6)
    - [Query](#query)
    - [Submitting the Query to the Dataset](#submitting-the-query-to-the-dataset)
...
- [As & With](#as--with)
    - [Setup](#setup-9)
    - [Query](#query-3)
    - [From the Exercise](#from-the-exercise)
- [Joining Data](#joining-data)
    - [Setup](#setup-10)
    - [Query](#query-4)
    - [Selecting the Specific Rows](#selecting-the-specific-rows)
    - [Query Generalization](#query-generalization)

</details>

<details><summary><a href="#advanced-sql">Advanced SQL</a></summary>
...
- [Analytic Functions](#analytic-functions)
    ...
    - [Setup](#setup-12)
    - [Query](#query-6)
    - [From the Exercise](#from-the-exercise-1)
...
- [Writing Efficient Queries](#writing-efficient-queries)
    ...
    - [SELECT What You Want](#select-what-you-want)
    - [Read Less Data](#read-less-data)
    - [Avoid N:N JOINs](#avoid-nn-joins)

</details>

<details><summary><a href="#machine-learning-explainability">Machine Learning Explainability</a></summary>

- [Use Cases for Model Insights](#use-cases-for-model-insights)
    - [Possible Types of Insights](#possible-types-of-insights)
    - [Why are these Insights Valuable](#why-are-these-insights-valuable)
- [Permutation Importance](#permutation-importance)
    - [Introduction](#introduction-16)
    - [How It Works](#how-it-works)
    - [From the Exercise](#from-the-exercise-2)
- [Partial Plots](#partial-plots)
    - [Introduction](#introduction-17)
    - [How It Works](#how-it-works-1)
    - [From the Exercise](#from-the-exercise-3)
- [SHAP Values](#shap-values)
    - [Introduction](#introduction-18)
    - [How It Works](#how-it-works-2)
    - [From the Exercise](#from-the-exercise-4)
- [Advanced Uses of SHAP Values](#advanced-uses-of-shap-values)
    - [Introduction](#introduction-19)
    - [Summary Plots](#summary-plots)
    - [Dependence Contribution Plots](#dependence-contribution-plots)
    - [From the Exercise](#from-the-exercise-5)

</details>

<details><summary><a href="#natural-language-processing">Natural Language Processing</a></summary>
...
- [Intro to NLP](#intro-to-nlp)
    ...
    - [From the Exercise](#from-the-exercise-6)
- [Text Classification](#text-classification)
    - [Intro](#intro-9)
    - [Bag-of-Words](#bag-of-words)
    - [Training a Text Categorizer Model](#training-a-text-categorizer-model)
